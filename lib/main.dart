  ...
  if (GetPlatform.isWeb) {
    await Firebase.initializeApp(
        options: const FirebaseOptions(
          apiKey: 'AIzaSyBbmOEq28_2s-aso8g8rFYFZGOImQAU_vc',
          appId: '1:1095418620195:android:f01ee78787cd95a7920496',
          messagingSenderId: '1095418620195',
          projectId: 'kanz-notifications',
    ));
    MetaSEO().config();
